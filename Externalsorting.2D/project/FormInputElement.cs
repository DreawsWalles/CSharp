...
namespace project
{
    public partial class FormInputElement : Form
    {
        ...
        {
            FormInput form = new FormInput("Введите призы, отделяя их запятой");
            form.ShowDialog();
        ...
        {
            FormInput form = new FormInput("Введите главных героев, отделяя их запятой");
            form.ShowDialog();
            if (form.DialogResult == DialogResult.OK)
            {
